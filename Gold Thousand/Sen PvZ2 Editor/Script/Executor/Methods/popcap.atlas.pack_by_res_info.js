        ...
        (function (Executor) {
            ...
            (function (Methods) {
                ...
                (function (PopCap) {
                    ...
                    (function (Atlas) {
                        var PackByResInfo;
                        (function (PackByResInfo) {
                            let Detail;
                            (function (Detail) {
                                Detail.dimension = [128n, 256n, 512n, 1024n, 2048n, 4096n, 8192n, 16384n];
                                Detail.padding = [1n, 2n, 3n, 4n, 5n, 6n, 7n, 8n, 9n, 10n];
                            })(Detail = PackByResInfo.Detail || (PackByResInfo.Detail = {}));
                            function forward() {
                                Sen.Script.Executor.push_as_module({
                                    id: "popcap.atlas.pack_by_res_info",
                                    configuration_file: Script.Home.query("~/Executor/Configuration/popcap.atlas.pack_by_res_info.json"),
                                    ...
                                    direct_forward(argument) {
                                        ...
                                        Script.Support.PopCap.Atlas.Pack.ResInfo.process_fs(argument.source, argument.size, argument.detail, argument.destination);
                            ...
                            PackByResInfo.forward = forward;
                        })(PackByResInfo = Atlas.PackByResInfo || (Atlas.PackByResInfo = {}));
