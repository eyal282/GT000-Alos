            ...
            (function (Methods) {
                ...
                (function (PopCap) {
                    ...
                    (function (Animation) {
                        ...
                        (function (FromFlashAndEncode) {
                            function forward() {
                                Sen.Script.Executor.push_as_module({
                                    ...
                                    configuration_file: Script.Home.query("~/Executor/Configuration/popcap.animation.from_flash_and_encode.json"),
                                    direct_forward(argument) {
                                        ...
                                        Sen.Kernel.Support.PopCap.Animation.Instance.from_flash(argument.source, argument.destination, argument.has_label);
                        ...
                        })(FromFlashAndEncode = Animation.FromFlashAndEncode || (Animation.FromFlashAndEncode = {}));
