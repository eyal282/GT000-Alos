            ...
            (function (Methods) {
                ...
                (function (PopCap) {
                    ...
                    (function (ReAnimation) {
                        ...
                        (function (Encode) {
                            ...
                            function forward() {
                                Sen.Script.Executor.push_as_module({
                                    ...
                                    configuration_file: Script.Home.query("~/Executor/Configuration/popcap.reanim.encode.json"),
                                    direct_forward(argument) {
                                        ...
                                        Script.Console.argument(Sen.Kernel.Language.get("popcap.reanim.encode.generic"));
                                        Executor.configurate_or_input(argument, "platform", Detail.platform());
                                        Executor.clock.start_safe();
                                        Sen.Kernel.Support.PopCap.ReAnimation.encode_fs(argument.source, argument.destination, argument.platform);
                        ...
                        })(Encode = ReAnimation.Encode || (ReAnimation.Encode = {}));
